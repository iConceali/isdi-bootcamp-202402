// app/src/components/TechnicalIndicatorOpportunityCard.jsx
...
const TechnicalIndicatorOpportunityCard = ({ opportunity }) => {
...
export default TechnicalIndicatorOpportunityCard;
