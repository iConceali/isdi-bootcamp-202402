// api/controllers/arbitrageStandardController.js

import * as arbitrageService from "../logic/arbitrageStandardService.js";

export const detectStandard = async (req, res) => {
  try {
    const opportunities = await arbitrageService.detectArbitrageAndSave();
